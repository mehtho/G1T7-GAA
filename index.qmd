...
WhatTown involves Spatially Constrained Clustering to differentiate neighbourhoods in Singapore according to the types of facilities that provide items necessary for daily living and Kernel Density Estimation to determine the coverage of there facilities.
...
WhatTown aims to be a web application to guide users through the process of Exploratory Data Analysis, Spatially Constrained Clustering, and Kernel Density Estimation without any technical skills required.
